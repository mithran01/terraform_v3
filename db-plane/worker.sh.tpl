...
echo "================================================="
echo "STARTING db NODE CONFIGURATION"
echo "================================================="
...
KUBELET_EXTRA_ARGS="--cloud-provider=external --hostname-override=$HOSTNAME --node-labels=node-type=db-plane,environment=prod,role=db --register-with-taints=dedicated=db:NoSchedule"
EOF
...
echo "================================================="
echo "db NODE JOINED SUCCESSFULLY"
echo "================================================="